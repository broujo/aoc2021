...
let input =
  ...
  |> M.add (Room (Amber, 2)) Desert
  |> M.add (Room (Amber, 3)) Desert
  |> M.add (Room (Bronze, 0)) Copper
  |> M.add (Room (Bronze, 1)) Copper
  |> M.add (Room (Bronze, 2)) Bronze
  |> M.add (Room (Bronze, 3)) Amber
  |> M.add (Room (Copper, 0)) Bronze
  |> M.add (Room (Copper, 1)) Bronze
  |> M.add (Room (Copper, 2)) Amber
  |> M.add (Room (Copper, 3)) Desert
  |> M.add (Room (Desert, 0)) Copper
  |> M.add (Room (Desert, 1)) Amber
  |> M.add (Room (Desert, 2)) Copper
  |> M.add (Room (Desert, 3)) Bronze
